...
- [ ] **Phase 1: Plugin Shell + Three-Process IPC** - UE C++ plugin + NyraHost Python sidecar + NyraInfer llama.cpp + Slate chat panel skeleton; Ring 0 "it can talk" (5/16 plans complete — Wave 1 DONE: 01-03, 01-01, 01-02, 01-04, 01-05 all shipped 2026-04-21)
