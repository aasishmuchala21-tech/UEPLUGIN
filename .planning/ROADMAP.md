...
- [ ] **Phase 1: Plugin Shell + Three-Process IPC** - UE C++ plugin + NyraHost Python sidecar + NyraInfer llama.cpp + Slate chat panel skeleton; Ring 0 "it can talk" (1/15 plans complete — 01-03 shipped 2026-04-21)
...
| 1. Plugin Shell + Three-Process IPC | 0/? | Not started | - |
