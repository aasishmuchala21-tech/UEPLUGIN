...
- [ ] **Phase 1: Plugin Shell + Three-Process IPC** - UE C++ plugin + NyraHost Python sidecar + NyraInfer llama.cpp + Slate chat panel skeleton; Ring 0 "it can talk" (8/16 plans complete — Wave 1 DONE: 01-03, 01-01, 01-02, 01-04, 01-05 shipped 2026-04-21; Wave 2 IN PROGRESS: 01-06 nyrahost-core-ws-auth-handshake + 01-07 nyrahost-storage-attachments + 01-08 nyrahost-infer-spawn-ollama-sse shipped 2026-04-22, 01-09 next)
